      ...
      {useAvatarGroup ? (
        ...
        <Stack component="Stack" direction={direction} spacing={spacing}>
          {avatars.map((avatarProp) =>
            avatarProp.useBadge ? (
              <Badge
                color={avatarProp.color || color}
                variant={avatarProp.badgeVariant || badgeVariant}
                overlap={avatarProp.overlap || overlap}
                anchorOrigin={avatarProp.anchorOrigin || anchorOrigin}
                badgeContent={avatarProp.badgeContent || badgeContent}
              >
                <NMSAvatar
                  alt={avatarProp.alt || alt}
                  src={avatarProp.src || src}
