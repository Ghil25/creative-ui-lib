...
import NMSBadge from "../../Badge/Badge";
import Icon from "../../../Foundation/Icons/Icon";
import { NMSAvatar, NMSAvatarGroup, NMSStack } from "../../Avatar";
export default {
  title: "Sample/DataDisplay/Avatar",
  component: NMSAvatar,
  argTypes: {
    groupParent: {
...
const Template = ({
  ...
  <>
    {useAvatarGroup ? (
      <NMSAvatarGroup {...groupParent}>
        {avatars.map((avatar, index) => {
          return <NMSAvatar key={index} {...avatar} />;
        })}
      </NMSAvatarGroup>
    ) : (
      <NMSStack {...groupParent}>
        {avatars.map((avatar, index) => {
          const {
            usebadge,
            color,
          ...
          return usebadge ? (
            <NMSBadge key={index} {...avatar}>
              <NMSAvatar {...avatar} />
            </NMSBadge>
          ) : (
            <NMSAvatar key={index} {...avatar} />
          );
        })}
      </NMSStack>
    )}
