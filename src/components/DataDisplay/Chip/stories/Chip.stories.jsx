...
DeletableChips.args = {
    ...
    chips : [ {
        ...
        variant: "filled",
        color: "primary",
        onDelete: ()=> { return console.info('you clicke the delete icon')}
    },
{
    label: 'chip outlined',
    variant: "outlined",
    ...
    },
{
        ...
        clickable: true,
        avatar: <Avatar alt="DG" src="https://media.istockphoto.com/id/147694372/photo/badger-dog.jpg?s=612x612&w=0&k=20&c=3iNYkarzevpIJeHcmQAykq0cubiSlL4URl91qIlacxM=" />
},
]
}
